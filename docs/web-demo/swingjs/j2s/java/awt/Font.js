...
Clazz.newMeth(C$, 'createGlyphVector$java_awt_font_FontRenderContext$S',  function (frc, str) {
return Clazz.new_($I$(14,1).c$$java_awt_Font$S$java_awt_font_FontRenderContext,[this, str, frc]);
});

Clazz.newMeth(C$, 'createGlyphVector$java_awt_font_FontRenderContext$CA',  function (frc, chars) {
return Clazz.new_($I$(14,1).c$$java_awt_Font$CA$java_awt_font_FontRenderContext,[this, chars, frc]);
});

Clazz.newMeth(C$, 'createGlyphVector$java_awt_font_FontRenderContext$java_text_CharacterIterator',  function (frc, ci) {
return Clazz.new_($I$(14,1).c$$java_awt_Font$java_text_CharacterIterator$java_awt_font_FontRenderContext,[this, ci, frc]);
});

Clazz.newMeth(C$, 'createGlyphVector$java_awt_font_FontRenderContext$IA',  function (frc, glyphCodes) {
return Clazz.new_($I$(14,1).c$$java_awt_Font$IA$java_awt_font_FontRenderContext,[this, glyphCodes, frc]);
});
...
;Clazz.setTVer('5.0.1-v5');//Created 2025-03-05 22:16:20 Java2ScriptVisitor version 5.0.1-v5 net.sf.j2s.core.jar version 5.0.1-v5
