...
/*i*/var C$=Clazz.newInterface(P$, "Path", null, null, ['Comparable', 'Iterable', 'java.nio.file.Watchable']);

C$.$clinit$=2;
C$.$defaults$ = function(C$){

/*$synth$*/C$.prototype['compareTo$java_nio_file_Path']=C$.prototype['compareTo$O'];
};})();
