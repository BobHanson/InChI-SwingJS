...
var name=this.$methodList$[i];
var isNative=(this.$clazz$[o.exName].isNative ||false);
ms[i]=Clazz.new_([this, name, null, Clazz.getClass($I$(15)), null, p$1.getMods$Z.apply(this, [isNative])],$I$(1,1).c$$Class$S$ClassA$Class$ClassA$I);
}
return ms;
...
for (attr in p) { o = p[attr]; if ( typeof o == "function" && o.exName && !o.__CLASS_NAME__ && o != this.$clazz$[attr] && (isAll || o.exClazz == this.$clazz$) && !o.exName.startsWith("c$") ) { isNative = o.isNative;
var m=Clazz.new_([this, attr, Class.UNKNOWN_PARAMETERS, Clazz.getClass($I$(15)), Class.NO_PARAMETERS, p$1.getMods$Z.apply(this, [isNative])],$I$(1,1).c$$Class$S$ClassA$Class$ClassA$I);
m._setJSMethod$O$I(o, 1);

ms.push(m);
}} p = this.$clazz$;
for (attr in p) { o = p[attr];if ( typeof o == "function" && o.exName && !o.__CLASS_NAME__ && (isAll || o.exClazz == this.$clazz$) && o.exName.indexOf("$") != 0 && !o.exName.startsWith("c$") ) { isNative = o.isNative;
m=Clazz.new_([this, attr, Class.UNKNOWN_PARAMETERS, Clazz.getClass($I$(15)), Class.NO_PARAMETERS, p$1.getMods$Z.apply(this, [isNative])],$I$(1,1).c$$Class$S$ClassA$Class$ClassA$I);
...
Clazz.newMeth(C$, 'getMods$Z',  function (isNative) {
var mods=1;
if (isNative) mods|=256;
return mods;
}, p$1);
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(21,1),[this,null])});
})()
...
;Clazz.setTVer('5.0.1-v5');//Created 2025-03-05 22:16:38 Java2ScriptVisitor version 5.0.1-v5 net.sf.j2s.core.jar version 5.0.1-v5
