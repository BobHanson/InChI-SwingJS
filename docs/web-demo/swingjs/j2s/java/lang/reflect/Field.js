...
return (this.myType=$I$(1,"typeForString$S$Z",[this.myType.toString(), true]));
});
...
;Clazz.setTVer('5.0.1-v5');//Created 2025-03-06 15:55:53 Java2ScriptVisitor version 5.0.1-v5 net.sf.j2s.core.jar version 5.0.1-v5
