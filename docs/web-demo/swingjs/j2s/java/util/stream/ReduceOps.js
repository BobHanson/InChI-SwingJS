...
), Clazz.new_([this, {supplier:supplier,accumulator:accumulator,collector:collector,combiner:combiner}, $I$(5).REFERENCE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$3));
}, 1);
...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_($I$(3,1),[this, {seedFactory:this.$finals$.seedFactory,reducer:this.$finals$.reducer,accumulator:this.$finals$.accumulator}],P$.ReduceOps$4ReducingSink);
});
})()
), Clazz.new_([this, {seedFactory:seedFactory,reducer:reducer,accumulator:accumulator}, $I$(5).REFERENCE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$4));
}, 1);
...
), Clazz.new_([this, {operator:operator,identity:identity}, $I$(5).INT_VALUE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$5));
}, 1);
...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_($I$(3,1),[this, {combiner:this.$finals$.combiner,accumulator:this.$finals$.accumulator,supplier:this.$finals$.supplier}],P$.ReduceOps$7ReducingSink);
});
})()
), Clazz.new_([this, {combiner:combiner,accumulator:accumulator,supplier:supplier}, $I$(5).INT_VALUE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$7));
}, 1);
...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_(P$.ReduceOps$8ReducingSink.$init$,[this, {identity:this.$finals$.identity,operator:this.$finals$.operator}]);
});
})()
), Clazz.new_([this, {identity:identity,operator:operator}, $I$(5).LONG_VALUE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$8));
}, 1);
...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_($I$(3,1),[this, {combiner:this.$finals$.combiner,accumulator:this.$finals$.accumulator,supplier:this.$finals$.supplier}],P$.ReduceOps$10ReducingSink);
});
})()
), Clazz.new_([this, {combiner:combiner,accumulator:accumulator,supplier:supplier}, $I$(5).LONG_VALUE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$10));
}, 1);
...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_($I$(3,1),[this, {accumulator:this.$finals$.accumulator,combiner:this.$finals$.combiner,supplier:this.$finals$.supplier}],P$.ReduceOps$13ReducingSink);
});
})()
), Clazz.new_([this, {accumulator:accumulator,combiner:combiner,supplier:supplier}, $I$(5).DOUBLE_VALUE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$13));
}, 1);
;
...
;Clazz.setTVer('5.0.1-v4');//Created 2025-02-12 08:28:38 Java2ScriptVisitor version 5.0.1-v4 net.sf.j2s.core.jar version 5.0.1-v4
