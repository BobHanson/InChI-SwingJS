...
), Clazz.new_(P$.Collectors$lambda55.$init$,[this, {mapper:mapper,op:op}])), ((P$.Collectors$lambda56||
...
), Clazz.new_(P$.Collectors$lambda66.$init$,[this, {downstreamAccumulator:downstreamAccumulator,predicate:predicate}]));
...
), Clazz.new_(P$.Collectors$lambda72.$init$,[this, {keyMapper:keyMapper,mergeFunction:mergeFunction,valueMapper:valueMapper}]));
...
;Clazz.setTVer('5.0.1-v4');//Created 2025-02-12 08:28:36 Java2ScriptVisitor version 5.0.1-v4 net.sf.j2s.core.jar version 5.0.1-v4
