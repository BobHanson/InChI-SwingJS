...
), Clazz.new_([this, {helper:helper,spliterator:spliterator,reduceOp:reduceOp}, upstream, $I$(14).REFERENCE, $I$(6).IS_DISTINCT | $I$(6).NOT_SIZED],$I$(13,1).c$$java_util_stream_AbstractPipeline$java_util_stream_StreamShape$I,P$.DistinctOps$1));
}, 1);
})();
