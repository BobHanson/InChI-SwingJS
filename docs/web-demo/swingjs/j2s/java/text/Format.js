...
return this.format$O$StringBuffer$java_text_FieldPosition(obj, Clazz.new_($I$(1,1)), (this.isSimpleMMDDYY ? null : Clazz.new_($I$(2,1).c$$I,[0]))).toString();
});
...
;Clazz.setTVer('5.0.1-v6');//Created 2025-03-09 12:58:41 Java2ScriptVisitor version 5.0.1-v6 net.sf.j2s.core.jar version 5.0.1-v6
