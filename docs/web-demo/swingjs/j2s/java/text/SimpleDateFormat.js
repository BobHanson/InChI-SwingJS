(function(){var P$=Clazz.newPackage("java.text"),p$1={},I$=[[0,'java.util.Hashtable','java.util.Locale','sun.util.locale.provider.LocaleProviderAdapter','java.text.NumberFormat','java.text.DateFormatSymbols','java.util.Calendar','java.util.TimeZone','StringBuilder','StringBuffer','java.text.FieldPosition','java.text.CharacterIteratorFieldDelegate',['java.text.DateFormat','.Field'],'sun.util.calendar.CalendarUtils','java.text.DontCareFieldPosition','java.text.ParsePosition']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.c$$I$I$java_util_Locale.apply(this, [3, 3, $I$(2).getDefault$()]);
}, 1);
...
this.pattern=$I$(3).getResourceBundleBased$().getLocaleResources$java_util_Locale(loc).getDateTimePattern$I$I$java_util_Calendar(3, 3, this.getCalendar$());
...
if (this.locale == null ) this.locale=$I$(2).getDefault$();
this.compiledPattern=p$1.compile$S.apply(this, [this.pattern]);
this.numberFormat=C$.cachedNumberFormatData.get$O(this.locale);
...
;Clazz.setTVer('5.0.1-v6');//Created 2025-03-09 16:20:24 Java2ScriptVisitor version 5.0.1-v6 net.sf.j2s.core.jar version 5.0.1-v6
