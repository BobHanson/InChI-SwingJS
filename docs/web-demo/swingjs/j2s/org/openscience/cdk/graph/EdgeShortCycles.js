...
/*c*/var C$=Clazz.newClass(P$, "EdgeShortCycles");
...
var sizeOf=Clazz.array(Integer.TYPE, [initialCycles.numberOfEdges$()]);
...
var idx=initialCycles.indexOfEdge$I$I(path[i - 1], path[i]);
