...
async function test(inchiVersion) {
 ...
 // var nativeMol = module.ccall("IXA_MOL_Create", "number", ["string"], [null]);
  ...
  IxaFunctions.IXA_MOL_SetAtomElement = module.cwrap("IXA_MOL_SetAtomElement", null, ["number", "number", "number", "number"]);
  ...
  IxaFunctions.IXA_MOL_SetAtomElement(logger, nativeMol, nativeAtom, module.stringToNewUTF8("N"));
//  alert(x);
